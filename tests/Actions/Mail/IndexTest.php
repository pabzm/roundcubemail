...
class IndexTest extends ActionTestCase
{
    ...
    public function test_options_menu_link()
    {
        ...
        $expected = '<a href="#list-options" data-onclick="' . json_encode(['command', 'menu-open', 'messagelistmenu', '__THIS__', '__EVENT__']) . '"'
    ...
    public function test_address_string()
    {
        ...
        $expected = '<span class="adr"><a href="mailto:test@domain.com" class="rcmContactAddress" '
            . 'data-onclick="' . json_encode(['command', 'compose', 'test@domain.com', '__THIS__']) . '" title="test@domain.com">'
            . 'test@domain.com</a><a href="#add" title="Add to address book" class="rcmaddcontact" '
            . 'data-onclick="' . json_encode(['command', 'add-contact', 'test@domain.com', '__THIS__']) . '"></a></span>';
    ...
    public function test_html_xss()
    {
        ...
        $this->assertDoesNotMatchRegularExpression('/data-onclick="' . json_encode(['command', 'compose', 'xss@somehost.net', '__THIS__']) . '"/', $html, 'Clean mailto links');
    ...
    public function test_plaintext()
    {
        ...
        $this->assertMatchesRegularExpression(
            '/<a href="mailto:nobody@roundcube.net" data-onclick="' . json_encode(['command', 'compose', 'nobody@roundcube.net', '__THIS__']) . '">nobody@roundcube.net<\/a>/',
            $html,
